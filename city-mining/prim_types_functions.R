...
# Finished Cities: Chicago, Detroit

property <- c("ARSON", "BURGLARY", "CRIMINAL DAMAGE", "CRIMINAL TRESPASS", "MOTOR VEHICLE THEFT", "THEFT", "LARCENY", "STOLEN VEHICLE")
violent <- c("ASSAULT", "BATTERY", "CRIM SEXUAL ASSAULT", "DOMESTIC VIOLENCE", "HOMICIDE", "HUMAN TRAFFICKING", "INTIMIDATION", "KIDNAPPING", "ROBBERY", "SEX OFFENSE", "STALKING", "WEAPONS VIOLATION", "AGGRAVATED ASSAULT")
